...
export default function PairConflict() {
  const [page, setPage] = useState(1)
  const [searchNumbers, setSearchNumbers] = useState<string>('')

  const { data, isLoading } = trpc.analysis.pairConflict.useQuery({
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex items-center justify-between mb-2">
        <div>
          <h2 className="text-xl font-semibold">상극</h2>
          <p className="text-sm text-slate-500 mt-1">30회 미만 함께 나온 번호들</p>
        </div>
